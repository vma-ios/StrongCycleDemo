...
class Cycle4ViewController: TestViewController {
    ...
    lazy var passwordAlertController: UIAlertController = {
        let ctrl = UIAlertController(title: "Enter Password", message: "You have selected to enter your passwod.", preferredStyle: UIAlertController.Style.alert)
        ctrl.addAction(UIAlertAction(title: "Cancel", style: UIAlertAction.Style.default, handler: nil))
        ctrl.addAction(UIAlertAction(title: "OK", style: UIAlertAction.Style.default, handler: { (action) -> Void in
